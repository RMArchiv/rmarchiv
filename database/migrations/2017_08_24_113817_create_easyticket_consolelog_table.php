...
class CreateEasyticketConsolelogTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('easyticket_consolelog', function (Blueprint $table) {
            ...
            // Console Log Example:
            // [Error] Refused to load http://rmarchiv.de/storage/attachments/Km080Glu0f9qfFtitp6tr93UAqWyZ54b4LGlxfMT.png because it does not appear in the img-src directive of the Content Security Policy. (x2)
