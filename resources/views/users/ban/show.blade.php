...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                @if($user->isNotBanned())
                    <form method="POST" action="{{action('UserBanController@ban', $user->id)}}">
                        @csrf
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input autocomplete="off" class="auto form-control" name="banreason" id="banreason" placeholder="" value="" required/>
                                </div>
                            </div>
                ...
                @else
                    <form method="POST" action="{{action('UserBanController@unban', $user->id)}}">
                        @csrf
                        <div class="card">
                            <div class="card-header">
