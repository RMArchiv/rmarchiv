                    ...
                    @foreach($news as $item)
                        @if($item->approved == 1)
                            <li class="list-group-item media" style="margin-top: 0px;">
                                ...
                                <a class="pull-left" href="{{ url('users', $item->user->id) }}"><img class="media-object img-rounded" width="42px" src="//ava.rmarchiv.de/?size=42&gender=male&id={{ $item->user->id }}" alt="{{ $item->user->name }}"></a>
