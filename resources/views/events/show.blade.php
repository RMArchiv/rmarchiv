                        ...
                        @foreach($event->comments as $comment)
                            <div class='comment cite-{{ $comment->user_id }}' id='c{{ $comment->id }}'>
                                ...
                                <div class='foot'>
                                    ...
                                    <a href='{{ url('users', $comment->user_id) }}' class='usera' title="{{ $comment->name }}"><img src='//{{ config('avatar_path') }}?gender=male&id={{ $comment->user_id }}' alt="{{ $comment->name }}" class='avatar' />
                                    </a>
                                </div>
                            </div>
                        @endforeach
