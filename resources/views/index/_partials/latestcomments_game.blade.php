        ...
        <li>
            <span class='rowprod'>
                <span class='prodentry'>
                    <span class='typeiconlist'>
                        ...
                        <span class='typei type_{{ $com->game->gamefiles[0]->gamefiletype->short}}' title='{{ $com->game->gamefiles[0]->gamefiletype->title}}'>
                    ...
                    <span class='prod'>
                        ...
                        <span><img src="/assets/lng/16/{{ strtoupper($com->game->language->short) }}.png" title="{{ $com->game->langname }}"></span>
                    </span>
            ...
            <span class='rowuser'>
                <a class='usera' href='{{ url('users', $com->user->id) }}' title="{{ $com->user->name }}">
                    <img alt="{{ $com->user->name }}" class='avatar' src='http://ava.rmarchiv.de/?gender=male&id={{ $com->user->id }}'>
                </a>
            </span>
        </li>
        @endforeach
