<div class='rmarchivtbl' id='rmarchivbox_login'>
    <h2>{{ trans('index.logout.title') }}</h2>
    <div class='content loggedin'>
        {{ trans('index.logout.loggedin_as') }}<br/>
    ...
    <div class='foot'>
        <a href='{{ url('user_settings') }}'>{{ trans('index.logout.settings') }}</a> ::
        <a href='{{ url('logout') }}'>{{ trans('index.logout.logout') }}</a>
    </div>
</div>