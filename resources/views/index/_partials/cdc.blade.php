<div class='rmarchivtbl' id='rmarchivbox_cdc'>
                ...
                <span class='prodentry'>
                    ...
                    <span class="platformiconlist">
                        <a href="{{ route('maker.show', $cdc->game->maker->id) }}">
                            <span class="typei type_{{ $cdc->game->maker->short }}"
                                  title="{{ $cdc->game->maker->title }}">
                    ...
                    <span class='prod'><a
                        ...
                        <span><img src="/assets/lng/16/{{ strtoupper($cdc->game->language->short) }}.png"
                                   title="{{ $cdc->game->language->name }}"></span>
    ...
    <div class='foot'>
        <time datetime='{{ $cdc->created_at }}'
              title='{{ $cdc->created_at }}'>{{ \Carbon\Carbon::parse($cdc->created_at)->diffForHumans() }}</time>
        :: <a href='{{ url('cdc') }}'>{{ trans('index.cdc.more') }}</a>...
    </div>
</div>