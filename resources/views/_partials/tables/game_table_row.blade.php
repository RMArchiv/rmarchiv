<li class="list-group-item media" style="margin-top: 0px;">
    ...
    <a class="pull-left" href="{{ url('games', $game->id) }}"><img width="64px" class="img-responsive img-rounded" src='{{ route('screenshot.show', [$game->id, 1]) }}' alt='{{ trans('games.show.titlescreen') }}' title='{{ trans('games.show.titlescreen') }}'/></a>
