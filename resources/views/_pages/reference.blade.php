@section('pagetitle', 'Component preview')
@section('content')
    @extends('layouts.app')
    @vite('resources/assets/js/cheatsheet.js')

    {{--
    Adapted and modified from bootstrap cheatsheet from https://getbootstrap.comhttps://getbootstrap.com/docs/5.3/examples/cheatsheet/
    no affiliation following https://creativecommons.org/licenses/by/3.0/ --}}

    <header class="bd-header bg-dark py-3 d-flex align-items-stretch border-bottom border-dark">
        <div class="container-fluid d-flex align-items-center">
            <h1 class="d-flex align-items-center fs-4 text-white mb-0">
                <img src="/assets/icon_rmarchiv.png" height="30" class="me-3" alt="Bootstrap">
                Cheatsheet
            </h1>
            <a href="https://getbootstrap.com/docs/5.3/examples/cheatsheet-rtl/" class="ms-auto link-light" hreflang="ar">RTL
                cheatsheet</a>
        </div>
    </header>
    ...
    <div class="bd-cheatsheet container-sm container-fluid bg-body">
        <section id="content">
        ...
        <section id="components">
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light bg-light">
                            <div class="container-fluid">
                                <a class="navbar-brand" href="#">
                                    <img src="/assets/icon_rmarchiv.png" height="30"
            ...
            <article class="my-3" id="toasts">
                <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
                    <h3>Toasts</h3>
                    <a class="d-flex align-items-center"
                        href="https://getbootstrap.com/docs/5.3/components/toasts/">Documentation</a>
                </div>
            ...
            <article class="mt-3 mb-5 pb-5" id="tooltips">
                <div class="bd-heading align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
                    <h3>Tooltips</h3>
                    <a class="d-flex align-items-center"
                        href="https://getbootstrap.com/docs/5.3/components/tooltips/">Documentation</a>
                </div>
