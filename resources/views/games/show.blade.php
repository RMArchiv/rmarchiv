                                    ...
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <a href='{{ url('users', $game->user_id) }}' class='usera' title="{{ $game->user->name }}">
                                                <img width="16px" src='//ava.rmarchiv.de/?gender=male&id={{ $game->user_id }}'
                                    ...
                                    <ul class="list-group">
                                        @if($game->credits->count() != 0)
                                            @foreach($game->credits as $cr)
                                                <li class="list-group-item">
                                                    <a href='{{ url('users', $cr->user_id) }}' class='usera' title="{{ $cr->user->name }}"><img width="16px" src='//ava.rmarchiv.de/?gender=male&id={{ $cr->user_id }}' alt="{{ $cr->user->name }}" class='avatar'/>
                                                    </a>
