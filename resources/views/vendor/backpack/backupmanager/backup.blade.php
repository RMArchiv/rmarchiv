      ...
      <table class="table table-hover table-condensed">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-right">
                @if ($b['download'])
                <a class="btn btn-xs btn-secondary" href="{{ url(config('backpack.base.route_prefix', 'admin').'/backup/download/') }}?disk={{ $b['disk'] }}&path={{ urlencode($b['file_path']) }}&file_name={{ urlencode($b['file_name']) }}"><i class="fa fa-cloud-download"></i> {{ trans('backpack::backup.download') }}</a>
                @endif
